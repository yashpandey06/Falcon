...
import com.falcon.utils.ResponseMessages.UNKNOWN_CONTAINER_ID
import com.falcon.utils.ResponseMessages.UNKNOWN_CONTAINER_NAME
...
object DockerUtils {
    ...
    fun mapToContainerDetails(containers: List<Container>): List<ContainerDetails> {
        return containers.map { container ->
            ContainerDetails(
                id = container.id ?: UNKNOWN_CONTAINER_ID,
                name = container.names?.firstOrNull()?.removePrefix("/") ?: UNKNOWN_CONTAINER_NAME,
